...
export const LIGHT_SURFACE_TEXT_FILL = StandingWavesColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link StandingWavesColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const STANDING_WAVES_COMBO_BOX_OPTIONS = {
  buttonFill: StandingWavesColors.controlSurfaceColorProperty,
  listFill: StandingWavesColors.controlSurfaceColorProperty,
  buttonStroke: StandingWavesColors.panelBorderColorProperty,
  listStroke: StandingWavesColors.panelBorderColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: StandingWavesColors.textColorProperty },
  },
